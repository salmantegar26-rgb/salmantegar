...
// Fungsi untuk mengambil dan mencetak isi Stack2 satu persatu sampai kosong
void printAndEmptyStack2(DoubleStack &s) {
    cout << "Mengambil dan mencetak isi Stack2 satu persatu:" << endl;
    while (!isEmpty2(s)) {
        int val = pop2(s);
    ...
    cout << endl << "Stack2 sekarang kosong." << endl;
}
...
int main() {
    ...
    // Isi Stack2 dengan beberapa elemen
    push2(s, 100);
    push2(s, 200);
    push2(s, 300);
    push2(s, 400);

    // Jalankan algoritma untuk mengambil dan mencetak isi Stack2
    printAndEmptyStack2(s);
